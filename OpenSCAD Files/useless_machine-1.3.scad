...
armFromYEdge=17;
//FIXME - remove this stuff - garbage position of arm 
//armYpos=40; 
//armXpos=0;
// files for arm
...
/*[Internal Supports]*/
//bQ/Ratio to determines the length and number of tabs on internal supports
//switch support
ssRatio=2.3;
...
module switchSupport(uDiv, holeZ=5, holeD=2.5) {
...
module placeBattery3D() {
  ...
  // move this into batPosX, batPosY, etc.
