...
RESOLUTION_MIN = 0.05 # smallest steps to take when moving
RESOLUTION_MAX = 10 # largest steps to take when moving
...
l = [50, 100, 110, 90, 70, 60]
last = 65
for i in l:
    print(f'current: {last}, dest: {i}')
    rotate_to_angle(last, i, 0.9999)
    time.sleep(3)
    last = i
